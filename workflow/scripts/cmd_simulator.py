...
parameters = """
    input = "." #path to the input folder. Note: contains the chromosomes fasta file and the genome annotation (in gtf or gff3 format)
    output = "." #path to the output folder
    max_genes =  10
    seq_depth  =  100

    seed = 42 #seed for a reproducible simulation
    ...
    readlen = 50 #read length
    max_genes = 10 #number of genes. NULL - use all compatible exon supersets
